...
use Statamic\Data\File\TaxonomyFolder;
...
class TaxonomiesController extends CpController
{
    ...
    public function index()
    {
        ...
        $groups = collect(Content::taxonomies())->filter(function ($taxonomy) {
    ...
    public function get()
    {
        ...
        foreach (Content::taxonomies() as $group) {
    ...
    public function delete()
    {
        ...
        foreach ($ids as $group_name) {
            Content::taxonomy($group_name)->delete();
        }
