...
class UrlBuilder implements UrlBuilderContract
{
    ...
    {
        if (! $content instanceof Entry && ! $content instanceof Term) {
    ...
    {
        // Routes can be defined as a string for just the route URL, or
        // they can be an array with route, template, etc, separately.
        // We just want to get the route URL out of there.
        $route_url = (is_array($route)) ? $route['route'] : $route;
