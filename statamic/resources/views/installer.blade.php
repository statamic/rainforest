                ...
                <div class="row" v-cloak>
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="card" v-if="cleanupFailed">
                            <div class="head">
                                <h1>Statamic is ready and waiting for you.</h1>
                            </div>
                            <hr>
                            <p class="text-danger">Please delete the <code>installer.php</code> file.</p>
                            <p><a :href="cpUrl" class="btn btn-primary">I deleted it. Take me to the Control Panel &rarr;</a></p>
                        </div>
