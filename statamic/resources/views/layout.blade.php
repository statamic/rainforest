	...
	<body id="statamic" :class="{ 'nav-visible': navVisible }">
		...
		<div class="content">
			...
			<div class="cp-head">
			    ...
			    <a href="" class="view" v-if="isPublishPage" @click.prevent="preview" v-cloak>
				    <span class="icon icon-eye"></span> {{ translate('cp.sneak_peek') }}
			    </a>

		        <a href="{{ route('site') }}" target="_blank" class="view" v-if="! isPublishPage" v-cloak>
